;;; everforest-hard-dark-theme.el --- Everforest Hard Dark Theme

;; Copyright 2022 Evan Sarris

;; Author: Evan Sarris <evan@theoryware.net>
;; URL: https://git.sr.ht/~theorytoe/everforest-hard-dark-theme
;; Version: 0.0.1
...
(defvar everforest-hard-dark-colors-alist
  (let* ((256color  (eq (display-color-cells (selected-frame)) 256))
         (colors `(("everforest-hard-dark-accent"   . "#a7c080")
                   ...
                   ("everforest-hard-dark-red-1"    . "#e67e80")
                   ("everforest-hard-dark-red-2"    . "#e67e80")
                   ("everforest-hard-dark-orange-1" . "#e69875")
                   ("everforest-hard-dark-orange-2" . "#ddbc7f")
...
(everforest-hard-dark-with-color-variables
  (custom-theme-set-faces
   ...
   `(warning             ((t (:foreground ,everforest-hard-dark-orange-2))))
   `(error               ((t (:foreground ,everforest-hard-dark-red-1 :weight bold))))
   ...
   `(hl-line             ((t (:background ,everforest-hard-dark-gray :distant-foreground nil))))
   ...
   `(font-lock-keyword-face           ((t (:foreground ,everforest-hard-dark-red-1 :weight normal))))
   `(font-lock-preprocessor-face      ((t (:foreground ,everforest-hard-dark-red-1))))
   ...
   ;; mode-line
   `(mode-line           ((t (:background "#262d33" :foreground ,everforest-hard-dark-silver))))
   ...
   `(ido-only-match  ((t (:foreground ,everforest-hard-dark-red-1 :weight bold))))
   ...
   `(ace-jump-face-foreground ((t (:foreground ,everforest-hard-dark-red-1 :background ,everforest-hard-dark-bg-1 :inverse-video nil))))

   ;; ace-window
   `(aw-background-face   ((t (:inherit font-lock-comment-face))))
   `(aw-leading-char-face ((t (:foreground ,everforest-hard-dark-red-1 :weight bold))))
   ...
   `(company-tooltip-common               ((t (:foreground ,everforest-hard-dark-orange-2 :background ,everforest-hard-dark-gray))))
   `(company-tooltip-common-selection     ((t (:foreground ,everforest-hard-dark-orange-2 :background ,everforest-hard-dark-mono-3))))
   `(company-preview                      ((t (:background ,everforest-hard-dark-bg))))
   `(company-preview-common               ((t (:foreground ,everforest-hard-dark-orange-2 :background ,everforest-hard-dark-bg))))
   ...
   `(flyspell-incorrect ((t (:underline (:color ,everforest-hard-dark-red-1 :style wave)))))

   ;; flymake
   `(flymake-error   ((t (:underline (:color ,everforest-hard-dark-red-1 :style wave)))))
   `(flymake-note    ((t (:underline (:color ,everforest-hard-dark-green :style wave)))))
   `(flymake-warning ((t (:underline (:color ,everforest-hard-dark-orange-1 :style wave)))))

   ;; flycheck
   `(flycheck-error   ((t (:underline (:color ,everforest-hard-dark-red-1 :style wave)))))
   `(flycheck-info    ((t (:underline (:color ,everforest-hard-dark-green :style wave)))))
   `(flycheck-warning ((t (:underline (:color ,everforest-hard-dark-orange-1 :style wave)))))
   ...
   `(isearch-fail   ((t (:foreground ,everforest-hard-dark-red-2 :background nil))))
   ...
   `(diredfl-number      ((t (:foreground ,everforest-hard-dark-red-1))))
   `(diredfl-date-time   ((t (:foreground ,everforest-hard-dark-blue))))
   `(diredfl-no-priv     ((t (:foreground ,everforest-hard-dark-orange-2))))
   `(diredfl-dir-priv    ((t (:foreground ,everforest-hard-dark-orange-2))))
   `(diredfl-read-priv   ((t (:foreground ,everforest-hard-dark-orange-2))))
   `(diredfl-write-priv  ((t (:foreground ,everforest-hard-dark-orange-2))))
   `(diredfl-exec-priv   ((t (:foreground ,everforest-hard-dark-orange-2))))
   `(diredfl-link-priv   ((t (:foreground ,everforest-hard-dark-orange-2))))
   ...
   `(dired-async-mode-message ((t (:foreground ,everforest-hard-dark-orange-1))))
   ...
   `(helm-source-header ((t (:foreground ,everforest-hard-dark-orange-2
                                         :background ,everforest-hard-dark-bg
                                         :underline nil
                                         :weight bold
                                         :box (:line-width 6 :color ,everforest-hard-dark-bg)))))
   ...
   `(helm-visible-mark                 ((t (:background ,everforest-hard-dark-bg :foreground ,everforest-hard-dark-orange-2))))
   `(helm-candidate-number             ((t (:foreground ,everforest-hard-dark-green :background ,everforest-hard-dark-bg-1))))
   `(helm-separator                    ((t (:background ,everforest-hard-dark-bg :foreground ,everforest-hard-dark-red-1))))
   `(helm-M-x-key                      ((t (:foreground ,everforest-hard-dark-orange-1))))
   `(helm-bookmark-addressbook         ((t (:foreground ,everforest-hard-dark-orange-1))))
   ...
   `(helm-bookmark-man                 ((t (:foreground ,everforest-hard-dark-orange-2))))
   `(helm-bookmark-w3m                 ((t (:foreground ,everforest-hard-dark-purple))))
   `(helm-match                        ((t (:foreground ,everforest-hard-dark-orange-2))))
   ...
   `(helm-ff-invalid-symlink           ((t (:foreground ,everforest-hard-dark-red-1 :background ,everforest-hard-dark-bg :weight bold))))
   `(helm-ff-symlink                   ((t (:foreground ,everforest-hard-dark-orange-2 :background ,everforest-hard-dark-bg :weight bold))))
   `(helm-ff-prefix                    ((t (:foreground ,everforest-hard-dark-bg :background ,everforest-hard-dark-orange-2 :weight normal))))
   `(helm-buffer-not-saved             ((t (:foreground ,everforest-hard-dark-red-1))))
   ...
   `(helm-grep-finish                  ((t (:foreground ,everforest-hard-dark-red-1))))
   ...
   `(info-menu-star                    ((t (:foreground ,everforest-hard-dark-red-1))))
   ...
   `(ivy-match-required-face        ((t (:inherit minibuffer-prompt :foreground ,everforest-hard-dark-red-1))))
   ...
   `(ivy-minibuffer-match-face-4    ((t (:inherit ivy-minibuffer-match-face-2 :background ,everforest-hard-dark-black :foreground ,everforest-hard-dark-orange-2 :weight semi-bold))))
   `(ivy-minibuffer-match-highlight ((t (:inherit ivy-current-match))))
   `(ivy-modified-buffer            ((t (:inherit default :foreground ,everforest-hard-dark-orange-1))))
   `(ivy-virtual                    ((t (:inherit font-lock-builtin-face :slant italic))))

   ;; counsel
   `(counsel-key-binding ((t (:foreground ,everforest-hard-dark-orange-2 :weight bold))))
   ...
   `(git-commit-comment-heading ((t (:foreground ,everforest-hard-dark-orange-2 :weight bold))))

   ;; git-gutter
   `(git-gutter:added    ((t (:foreground ,everforest-hard-dark-green :weight bold))))
   `(git-gutter:deleted  ((t (:foreground ,everforest-hard-dark-red-1 :weight bold))))
   `(git-gutter:modified ((t (:foreground ,everforest-hard-dark-orange-1 :weight bold))))

   ;; eshell
   `(eshell-ls-archive    ((t (:foreground ,everforest-hard-dark-purple :weight bold))))
   `(eshell-ls-backup     ((t (:foreground ,everforest-hard-dark-orange-2))))
   `(eshell-ls-clutter    ((t (:foreground ,everforest-hard-dark-red-2 :weight bold))))
   ...
   `(eshell-ls-missing    ((t (:foreground ,everforest-hard-dark-red-1 :weight bold))))
   `(eshell-ls-product    ((t (:foreground ,everforest-hard-dark-orange-2))))
   ...
   `(jabber-roster-user-away       ((t (:foreground ,everforest-hard-dark-red-1))))
   `(jabber-roster-user-xa         ((t (:foreground ,everforest-hard-dark-red-2))))
   `(jabber-roster-user-dnd        ((t (:foreground ,everforest-hard-dark-purple))))
   `(jabber-roster-user-chatty     ((t (:foreground ,everforest-hard-dark-orange-2))))
   `(jabber-roster-user-error      ((t (:foreground ,everforest-hard-dark-red-1 :bold t))))
   ...
   `(jabber-chat-prompt-foreign    ((t (:foreground ,everforest-hard-dark-orange-2))))
   ...
   `(eww-invalid-certificate ((t (:foreground ,everforest-hard-dark-red-1))))
   ...
   `(magit-section-heading             ((t (:foreground ,everforest-hard-dark-orange-2 :weight bold))))
   ...
   `(magit-diff-file-heading-selection ((t (:foreground ,everforest-hard-dark-orange-2 :background ,everforest-hard-dark-bg-hl :weight bold))))
   ...
   `(magit-diffstat-removed            ((t (:foreground ,everforest-hard-dark-red-1))))
   `(magit-process-ok                  ((t (:foreground ,everforest-hard-dark-green))))
   `(magit-process-ng                  ((t (:foreground ,everforest-hard-dark-red-1))))
   `(magit-log-author                  ((t (:foreground ,everforest-hard-dark-orange-2))))
   `(magit-log-date                    ((t (:foreground ,everforest-hard-dark-mono-2))))
   `(magit-log-graph                   ((t (:foreground ,everforest-hard-dark-silver))))
   `(magit-sequence-pick               ((t (:foreground ,everforest-hard-dark-orange-2))))
   `(magit-sequence-stop               ((t (:foreground ,everforest-hard-dark-green))))
   `(magit-sequence-part               ((t (:foreground ,everforest-hard-dark-orange-1))))
   `(magit-sequence-head               ((t (:foreground ,everforest-hard-dark-blue))))
   `(magit-sequence-drop               ((t (:foreground ,everforest-hard-dark-red-1))))
   ...
   `(magit-bisect-skip                 ((t (:foreground ,everforest-hard-dark-orange-1))))
   `(magit-bisect-bad                  ((t (:foreground ,everforest-hard-dark-red-1))))
   ...
   `(magit-blame-name                  ((t (:background ,everforest-hard-dark-bg-1 :foreground ,everforest-hard-dark-orange-2))))
   ...
   `(magit-tag                         ((t (:foreground ,everforest-hard-dark-orange-1 :weight bold))))
   ...
   `(magit-signature-bad               ((t (:foreground ,everforest-hard-dark-red-1))))
   `(magit-signature-untrusted         ((t (:foreground ,everforest-hard-dark-orange-1))))
   ...
   `(magit-reflog-reset                ((t (:foreground ,everforest-hard-dark-red-1))))
   ...
   `(message-header-cc          ((t (:foreground ,everforest-hard-dark-orange-1 :weight bold))))
   `(message-header-name        ((t (:foreground ,everforest-hard-dark-purple))))
   `(message-header-newsgroups  ((t (:foreground ,everforest-hard-dark-orange-2 :weight bold :slant italic))))
   `(message-header-other       ((t (:foreground ,everforest-hard-dark-red-1))))
   `(message-header-subject     ((t (:foreground ,everforest-hard-dark-blue))))
   `(message-header-to          ((t (:foreground ,everforest-hard-dark-orange-2 :weight bold))))
   ...
   `(notmuch-crypto-signature-bad         ((t (:foreground ,everforest-hard-dark-red-1 :background ,everforest-hard-dark-black))))
   ...
   `(notmuch-crypto-signature-unknown     ((t (:foreground ,everforest-hard-dark-orange-1 :background ,everforest-hard-dark-black))))
   ...
   `(notmuch-search-matching-authors      ((t (:inherit default :foreground ,everforest-hard-dark-orange-2))))
   `(notmuch-search-non-matching-authors  ((t (:inherit font-lock-comment-face :slant italic))))
   `(notmuch-tag-added                    ((t (:underline t))))
   `(notmuch-tag-deleted                  ((t (:strike-through ,everforest-hard-dark-red-2))))
   `(notmuch-tag-face                     ((t (:foreground ,everforest-hard-dark-green))))
   `(notmuch-tag-unread                   ((t (:foreground ,everforest-hard-dark-red-1))))
   ...
   `(elfeed-log-error-level-face      ((t (:background ,everforest-hard-dark-black :foreground ,everforest-hard-dark-red-1))))
   `(elfeed-log-info-level-face       ((t (:background ,everforest-hard-dark-black :foreground ,everforest-hard-dark-blue))))
   `(elfeed-log-warn-level-face       ((t (:background ,everforest-hard-dark-black :foreground ,everforest-hard-dark-orange-1))))
   `(elfeed-search-date-face          ((t (:foreground ,everforest-hard-dark-purple))))
   `(elfeed-search-feed-face          ((t (:foreground ,everforest-hard-dark-orange-2))))
   ...
   `(rainbow-delimiters-depth-2-face    ((t (:foreground ,everforest-hard-dark-red-1))))
   ...
   `(rainbow-delimiters-depth-6-face    ((t (:foreground ,everforest-hard-dark-orange-2))))
   `(rainbow-delimiters-depth-7-face    ((t (:foreground ,everforest-hard-dark-orange-1))))
   `(rainbow-delimiters-depth-8-face    ((t (:foreground ,everforest-hard-dark-green))))
   `(rainbow-delimiters-depth-9-face    ((t (:foreground ,everforest-hard-dark-orange-1))))
   ...
   `(rainbow-delimiters-depth-12-face   ((t (:foreground ,everforest-hard-dark-orange-2))))
   `(rainbow-delimiters-unmatched-face  ((t (:foreground ,everforest-hard-dark-red-1 :weight bold))))
   ...
   `(elixir-attribute-face  ((t (:foreground ,everforest-hard-dark-red-1))))

   ;; show-paren
   `(show-paren-match     ((,class (:foreground ,everforest-hard-dark-purple :inherit bold :underline t))))
   `(show-paren-mismatch  ((,class (:foreground ,everforest-hard-dark-red-1 :inherit bold :underline t))))

   ;; cider
   `(cider-fringe-good-face ((t (:foreground ,everforest-hard-dark-green))))

   ;; sly
   `(sly-error-face          ((t (:underline (:color ,everforest-hard-dark-red-1 :style wave)))))
   ...
   `(sly-style-warning-face  ((t (:underline (:color ,everforest-hard-dark-orange-2 :style wave)))))
   `(sly-warning-face        ((t (:underline (:color ,everforest-hard-dark-orange-1 :style wave)))))

   ;; smartparens
   `(sp-show-pair-mismatch-face ((t (:foreground ,everforest-hard-dark-red-1 :background ,everforest-hard-dark-gray :weight bold))))
   `(sp-show-pair-match-face    ((t (:foreground ,everforest-hard-dark-blue :weight bold :underline t))))

   ;; lispy
   `(lispy-face-hint ((t (:background ,everforest-hard-dark-border :foreground ,everforest-hard-dark-orange-2))))

   ;; lispyville
   `(lispyville-special-face ((t (:foreground ,everforest-hard-dark-red-1))))

   ;; spaceline
   `(spaceline-flycheck-error    ((,class (:foreground ,everforest-hard-dark-red-1))))
   `(spaceline-flycheck-info     ((,class (:foreground ,everforest-hard-dark-green))))
   `(spaceline-flycheck-warning  ((,class (:foreground ,everforest-hard-dark-orange-1))))
   ...
   `(web-mode-error-face              ((t (:background ,everforest-hard-dark-black :foreground ,everforest-hard-dark-red-1))))
   `(web-mode-html-attr-equal-face    ((t (:inherit default))))
   `(web-mode-html-attr-name-face     ((t (:foreground ,everforest-hard-dark-orange-1))))
   `(web-mode-html-tag-bracket-face   ((t (:inherit default))))
   `(web-mode-html-tag-face           ((t (:foreground ,everforest-hard-dark-red-1))))
   `(web-mode-symbol-face             ((t (:foreground ,everforest-hard-dark-orange-1))))

   ;; nxml
   `(nxml-attribute-local-name             ((t (:foreground ,everforest-hard-dark-orange-1))))
   `(nxml-element-local-name               ((t (:foreground ,everforest-hard-dark-red-1))))
   ...
   `(rpm-spec-obsolete-tag-face ((t (:foreground "#FFFFFF" :background ,everforest-hard-dark-red-2))))
   `(rpm-spec-macro-face        ((t (:foreground ,everforest-hard-dark-orange-2))))
   `(rpm-spec-var-face          ((t (:foreground ,everforest-hard-dark-red-1))))
   `(rpm-spec-doc-face          ((t (:foreground ,everforest-hard-dark-purple))))
   `(rpm-spec-dir-face          ((t (:foreground ,everforest-hard-dark-cyan))))
   `(rpm-spec-package-face      ((t (:foreground ,everforest-hard-dark-red-2))))
   `(rpm-spec-ghost-face        ((t (:foreground ,everforest-hard-dark-red-2))))
   `(rpm-spec-section-face      ((t (:foreground ,everforest-hard-dark-orange-2))))
   ...
   ;; gomoku
   `(gomoku-O ((t (:foreground ,everforest-hard-dark-red-1 :weight bold))))
   ...
   `(reb-match-3 ((t (:background ,everforest-hard-dark-black :foreground ,everforest-hard-dark-orange-2 :weight semi-bold))))
   ...
   `(desktop-entry-unknown-keyword-face    ((t (:underline (:color ,everforest-hard-dark-red-1 :style wave) :inherit font-lock-keyword-face))))
   ...
   ;; gud
   `(breakpoint-disabled ((t (:foreground ,everforest-hard-dark-orange-1))))
   `(breakpoint-enabled  ((t (:foreground ,everforest-hard-dark-red-1 :weight bold))))

   ;; realgud
   `(realgud-overlay-arrow1        ((t (:foreground ,everforest-hard-dark-green))))
   `(realgud-overlay-arrow3        ((t (:foreground ,everforest-hard-dark-orange-1))   `(realgud-overlay-arrow2        ((t (:foreground ,everforest-hard-dark-orange-2))))
                                    ))
   '(realgud-bp-enabled-face       ((t (:inherit (error)))))
   `(realgud-bp-disabled-face      ((t (:inherit (secondary-selection)))))
   `(realgud-bp-line-enabled-face  ((t (:box (:color ,everforest-hard-dark-red-1)))))
   ...
   `(ruler-mode-comment-column ((t (:foreground ,everforest-hard-dark-red-1))))
   ...
   `(ruler-mode-fill-column    ((t (:foreground ,everforest-hard-dark-orange-1 :inherit ruler-mode-default))))
   ...
   ;; undo-tree
   `(undo-tree-visualizer-current-face    ((t (:foreground ,everforest-hard-dark-red-2))))
   `(undo-tree-visualizer-register-face   ((t (:foreground ,everforest-hard-dark-orange-1))))
   ...
   `(all-the-icons-yellow    ((t (:foreground ,everforest-hard-dark-orange-2))))
   ...
   ;; markdown
   `(markdown-header-face-1            ((t (:foreground ,everforest-hard-dark-red-1 :weight bold))))
   `(markdown-header-face-2            ((t (:foreground ,everforest-hard-dark-orange-1 :weight bold))))
   ...
   `(org-level-2               ((t (:foreground ,everforest-hard-dark-red-1))))
   `(org-level-3               ((t (:foreground ,everforest-hard-dark-purple))))
   `(org-level-4               ((t (:foreground ,everforest-hard-dark-orange-1))))
   ...
   `(font-latex-warning-face             ((t (:foreground ,everforest-hard-dark-red-1))))
   ...
   ;; js2-mode
   `(js2-error             ((t (:underline (:color ,everforest-hard-dark-red-1 :style wave)))))
   `(js2-external-variable ((t (:foreground ,everforest-hard-dark-cyan))))
   `(js2-warning           ((t (:underline (:color ,everforest-hard-dark-orange-1 :style wave)))))
   ...
   `(js2-jsdoc-type        ((t (:foreground ,everforest-hard-dark-orange-2))))
   `(js2-jsdoc-value       ((t (:foreground ,everforest-hard-dark-red-1))))
   `(js2-object-property   ((t (:foreground ,everforest-hard-dark-red-1))))
...
(everforest-hard-dark-with-color-variables
  (custom-theme-set-variables
   ...
   ;; tetris
   ;; | Tetromino | Color                    |
   ;; | O         | `everforest-hard-dark-orange-2' |
   ;; | J         | `everforest-hard-dark-blue'     |
   ;; | L         | `everforest-hard-dark-orange-1' |
   ;; | Z         | `everforest-hard-dark-red-1'    |
   ...
   `(ansi-color-names-vector
     [,everforest-hard-dark-black ,everforest-hard-dark-red-1 ,everforest-hard-dark-green ,everforest-hard-dark-orange-2
      ,everforest-hard-dark-blue ,everforest-hard-dark-purple ,everforest-hard-dark-cyan ,everforest-hard-dark-fg])
   ))

(defvar everforest-hard-dark-theme-force-faces-for-mode t
  "If t, everforest-hard-dark-theme will use Face Remapping to alter the theme faces for
...
;; mode they see a different face.  That being said, you can set the `everforest-hard-dark-theme-force-faces-for-mode` variable to
;; `nil` to disable this feature.
(defun everforest-hard-dark-theme-change-faces-for-mode ()
  (interactive)
  (when (or everforest-hard-dark-theme-force-faces-for-mode (called-interactively-p))
    (everforest-hard-dark-with-color-variables
      (cond
       ((member major-mode '(js2-mode))
        (face-remap-add-relative 'font-lock-constant-face :foreground everforest-hard-dark-orange-1)
        (face-remap-add-relative 'font-lock-doc-face '(:inherit (font-lock-comment-face)))
        (face-remap-add-relative 'font-lock-variable-name-face :foreground everforest-hard-dark-mono-1))
       ((member major-mode '(html-mode))
        (face-remap-add-relative 'font-lock-function-name-face :foreground everforest-hard-dark-red-1)
        (face-remap-add-relative 'font-lock-variable-name-face :foreground everforest-hard-dark-orange-1))))))

(add-hook 'after-change-major-mode-hook 'everforest-hard-dark-theme-change-faces-for-mode)
