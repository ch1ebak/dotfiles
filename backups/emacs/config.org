...
(use-package general
  ...
  (me/leader-keys
    "f" '(:ignore t :wk "Files")
    "f b" '((lambda () (interactive) (find-file "~/.dotfiles/.bashrc")) :wk "Bash Config")
    "f p" '((lambda () (interactive) (find-file "~/.dotfiles/.config/emacs/config.org")) :wk "Emacs Config")
    "f q" '((lambda () (interactive) (find-file "~/.dotfiles/.config/qtile/config.py")) :wk "Qtile Config")
    "f n" '((lambda () (interactive) (find-file "~/Dokumenty/notatki/index.md")) :wk "Qtile Config")
