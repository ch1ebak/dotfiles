...
(use-package general
  ...
  (me/leader-keys
    ...
    "RET" '(counsel-find-file :wk "Find file")
    "/" '(counsel-ibuffer :wk "Ibuffer")
    "?" '(kill-buffer :wk "Kill buffer")
    "." '((lambda () (interactive) (counsel-find-file "~/.dotfiles/")) :wk "Dotfiles directory")
    ">" '((lambda () (interactive) (counsel-find-file "~/Dokumenty/notatki/")) :wk "Notes directory")
