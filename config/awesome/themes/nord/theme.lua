...
theme.weather = lain.widget.weather({
    ...
    weather_na_markup = markup.fontfg(theme.font, "#708090", "N/A "),
    settings = function()
        descr = weather_now["weather"][1]["description"]:lower()
        units = math.floor(weather_now["main"]["temp"])
        widget:set_markup(markup.fontfg(theme.font, "#708090", descr .. " @ " .. units .. "°C "))
    end
})
...
local net = lain.widget.net({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#708090", " " .. net_now.received .. " ↓↑ " .. net_now.sent .. " "))
    end
})
   ...
   s.quake = lain.util.quake({ app = "kitty", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- arrow("#2E3440", "#2E3440"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#2E3440"),
            arrow("#2E3440", "#2E3440"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#2E3440"),
            arrow("#2E3440", "#2E3440"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), "#2E3440"),
            arrow("#2E3440", "#2E3440"),
            wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, 4, 4), "#2E3440"),
            arrow("#2E3440", "#2E3440"),
            wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#2E3440"),
            arrow("#2E3440", "#2E3440"),
            wibox.container.background(wibox.container.margin(clock, 4, 8), "#2E3440"),
            arrow("#2E3440", "alpha"),
            --]]
            s.mylayoutbox,
        },
